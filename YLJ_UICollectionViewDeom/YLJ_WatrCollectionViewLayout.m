//
//  YLJ_WatrCollectionViewLayout.m
...
NSString *const YLJ_UICollectionElementKindSectionHeader = @"AC_HeadView";
NSString *const YLJ_UICollectionElementKindSectionFooter = @"AC_FootView";

@interface YLJ_WatrCollectionViewLayout()
...
@implementation YLJ_WatrCollectionViewLayout
...
-(void)prepareLayout{
    ...
    for (NSInteger section = 0; section < sectionsCount; section++) {
        ...
        if (_headerViewHeight>0 && [self.collectionView.dataSource respondsToSelector:@selector(collectionView: viewForSupplementaryElementOfKind: atIndexPath:)]) {
            ...
            UICollectionViewLayoutAttributes *attribute = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:YLJ_UICollectionElementKindSectionHeader withIndexPath:supplementaryViewIndexPath];
            //设置frame
        ...
        for (NSInteger row = 0; row < rowsCount; row++) {
            ...
            CGFloat height = [(id<YLJ_WatrCollectionViewLayoutDelegate>)self.delegate collectionView:self.collectionView layout:self heightOfItemAtIndexPath:cellIndePath itemWidth:itemWidth];
            //设置当前cell布局对象的frame
        ...
        if (_footViewHeight>0 && [self.collectionView.dataSource respondsToSelector:@selector(collectionView: viewForSupplementaryElementOfKind: atIndexPath:)]) {
            ...
            UICollectionViewLayoutAttributes *attribute = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:YLJ_UICollectionElementKindSectionFooter withIndexPath:supplementaryViewIndexPath];
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([elementKind isEqualToString:YLJ_UICollectionElementKindSectionHeader]) {
        attribute = self.headLayoutInfo[indexPath];
    }else if ([elementKind isEqualToString:YLJ_UICollectionElementKindSectionFooter]){
